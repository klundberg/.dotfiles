...
set --global fish_user_paths ~/bin (realpath $OMF_CONFIG/../../bin) ~//Library/Android/sdk/platform-tools/ ~/.fastlane/bin /usr/local/sbin
...
# # Android
# export PATH=$PATH:/Users/ckeenan/Library/Android/sdk/platform-tools/
